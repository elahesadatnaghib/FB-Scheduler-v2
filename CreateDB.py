...
def creatFBDE():
    ...
    cur.execute('CREATE TABLE NightSummary('
                ...
                'N_triple_WFD INTEGER, '
                'N_double_WFD INTEGER, '
                'N_single_WFD INTEGER, '
                'N_triple_GP INTEGER, '
                'N_double_GP INTEGER, '
                'N_single_GP INTEGER, '
                'N_triple_NES INTEGER, '
                'N_double_NES INTEGER, '
                'N_single_NES INTEGER, '
                'N_triple_SCP INTEGER, '
                'N_double_SCP INTEGER, '
                'N_single_SCP INTEGER, '
                'N_per_hour REAL, '
                'Avg_cost REAL, '
                'Avg_slew_t REAL, '
                'Avg_alt REAL, '
